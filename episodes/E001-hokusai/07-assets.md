...
| 10 | 11–12 · [PROMISE 1] | **Obra temprana firmada "Shunrō"** (actor kabuki, *hosoban*, 1780s) | Met Open Access: https://www.metmuseum.org/art/collection/search?q=Shunro&showOnly=openAccess — elegir una con **firma legible**, *Download* | Met | CC0 | ~4000 px | inserto + zoom a la firma → basta | |
