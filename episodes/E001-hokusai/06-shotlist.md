...
|---|-----------------|---------------|--------|-------------|----------|--------|--------|
| 1 · HOOK v1 | Cold open 0:00 (~3 s) | "en un cuarto de alquiler de Edo… se estaba muriendo" | Interior humilde de Edo en penumbra, luz de amanecer por shoji; sin cara | `E001_ai01_deathbed-room` (IA) · alt: `assets/intro/` (footage Japón) | ilustración propia (IA) / stock | `Ilustración — Éxodo` | corte seco |
...
> Los 4 planos del hook se eligen en la **fila Intro de `07-photography-pass.html`** (Stage 7). El pull trae candidatos de `INTRO1–3`; Josh añade propios o marca cards. `--download` los numera `assets/intro/intro01…` en orden de pantalla.
