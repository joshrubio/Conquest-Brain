# Outline — E004 «Coca-Cola» (beat sheet)
...
`cold open → bumper → pivote a contexto + época → narrativa cronológica (4 actos, con 2 explicadores + 3 foreshadowings) → cierre forma A (registro práctico) → CTA coda`
...
|---|---------|------|------|--------|-------------------|
| 1 | 0 · Cold open | Contraste: la bebida más reconocible del planeta empezó como un remedio de farmacia — para un hombre adicto a la morfina que buscaba curarse a sí mismo | 0:00–0:10 | [S01][S02] | Imagen de contraste (botella moderna / farmacia de 1880s) |
| 2 | 0 · Cold open | El hombre existió, tenía nombre — John Pemberton — y murió pobre, sin ver un centavo de lo que su fórmula se convirtió | 0:10–0:22 | [S01][S02] | **HOOK** — se paga en Acto 3 (muerte) y se retoma en el cierre |
| 3 | 0 · Cold open | «En este episodio: qué pasó de verdad con el hombre que inventó Coca-Cola, y por qué casi nadie lo sabe» | 0:22–0:32 | — | Nombra qué hará el episodio (`brain/02` §0) |
| 4 | 0b · Bumper | Negro, marca `Conquest`, «Hola, mi nombre es [nombre], y esto es Conquest» | 0:32–0:37 | — | Fraseo fijo, sin animación |
| 5 | 1 · Pivote | Sitúa a Pemberton antes de la herida: farmacéutico establecido en Columbus y luego Atlanta, boticario respetado, ya con negocios propios | | [S01] | «Para situarnos.» |
| 6 | 1 · Pivote | La época: el "patent medicine" — la era de los tónicos y remedios de venta libre en EE. UU., antes de cualquier regulación de fármacos | | — | **EXPLICADOR 1** — entrada señalizada |
| 7 | 1 · Pivote | **EXPLICADOR 1** — por qué la coca y la cocaína eran ingredientes legales y comunes en remedios de farmacia de la época (Vin Mariani, otros tónicos) | | [S02][S03] | ~130 palabras, salida señalizada: «con eso claro, volvamos a Pemberton» |
| 8 | 1 · Pivote | Bisagra: para entender por qué Pemberton llega a esto, hace falta ver qué le pasó en la guerra | | — | Pivota a la narrativa |
| 9 | 2 · Acto 1 — La herida (abril de 1865–1885) | Guerra Civil, herida en Columbus, la morfina como alivio del dolor | | [S01][S02] | — |
| 10 | 2 · Acto 1 | La adicción se instala; Pemberton, como farmacéutico, empieza a experimentar con sus propios tónicos buscando una alternativa | | [S02] | — |
| 11 | 2 · Acto 1 | Lanza "Pemberton's French Wine Coca" (1885) — vino + coca + nuez de cola, inspirado en el Vin Mariani francés; éxito local en Atlanta | | [S02] | **PROMISE 1** — «hay un ingrediente en este tónico que hoy conoces por otro nombre» → se paga en el Explicador 2 |
| 12 | 2 · Acto 1 | Se vende como remedio para el dolor de cabeza, tónico nervioso — y, con cierta ironía, como cura para la propia adicción a la morfina que Pemberton padecía | | [S02] | — |
| 13 | 3 · Acto 2 — 1886, nace Coca-Cola | Atlanta declara la prohibición local del alcohol; Pemberton retira el vino, lo sustituye por sirope de azúcar | | [S02][S03][S06] | — |
| 14 | 3 · Acto 2 | Frank Robinson, su socio y contable, sugiere el nombre «Coca-Cola» y escribe el logo en script Spencerian | | [S05] | Presentar a Robinson con una cláusula de por qué confiar en el dato (contable/socio directo) |
| 15 | 3 · Acto 2 | Mayo de 1886: se sirve el primer Coca-Cola, en la farmacia Jacobs' de Atlanta — la vende como la bebida ideal de la temperancia | | [S06] | — |
| 16 | 3 · Acto 2 | Matiz: cuando la prohibición termina en 1887, Pemberton retoma el French Wine Coca (con alcohol) — y durante un tiempo se vende más que la propia Coca-Cola | | [S02] | Complica la versión simple "prohibición → Coca-Cola para siempre"; se narra sin resolverlo de más |
| 17 | 4 · Acto 3 — La venta y la muerte (1887–1888) | Pemberton enferma, tiene problemas de dinero | | [S01][S02] | **PROMISE 2** — «esta misma fórmula está a punto de venderse, no una vez, sino varias, a la vez, a gente distinta» → se paga en el siguiente beat |
| 18 | 4 · Acto 3 | Vende participaciones superpuestas de los derechos a varias partes distintas — Margaret Dozier y Woolfolk Walker, luego J. C. Mayfield, y también a Asa Candler — un reparto caótico, no una venta limpia | | [S05] | **PAY 2** — matizar en pantalla que este punto viene de una fuente más floja (subir de tier antes de guion, ver dossier §6) |
| 19 | 4 · Acto 3 | Marzo de 1888: se presenta la petición de incorporación de "The Coca-Cola Company" — Pemberton todavía vivo | | [S01] | — |
| 20 | 4 · Acto 3 | 16 de agosto de 1888: muere John Pemberton en Atlanta — pobre, todavía adicto a la morfina | | [S01][S02] | **PAY 1** (del HOOK, parcial) |
| 21 | 5 · Acto 4 — El imperio de otro (1888–1903) | Asa Candler consolida la propiedad total de la fórmula hacia 1891, por un total citado de $2.300 | | [S02][S04] | — |
...
- [x] Sujeto: caso histórico + empresa documentada — sin persona privada ni viva (Pemberton, Candler y Robinson, fallecidos hace más de un siglo)

**Pendiente explícito para Stage 4 (guion) / Stage 5 (fact-check):** el beat 18 (reparto caótico de derechos, `[S05]`, Tier C) necesita subir de tier — localizar el registro judicial real del caso Mayfield o una cita con página de Pendergrast — antes de escribirlo con la misma seguridad en el guion; si no se confirma a tiempo, escribirlo de forma más genérica ("vendió participaciones a más de una persona") en vez de nombrar a las partes.
