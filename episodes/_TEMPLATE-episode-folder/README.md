...
Trabajar los archivos **en orden**. Cada uno corresponde a un stage de `brain/06-production-workflow.md` y se rellena a partir de la plantilla maestra en `templates/`.
...
| `07-style-pass.md` | 7 | `tools/pull_assets.py` (genera; hub del stage) |
| `07c-edit.md` | 9 | `templates/edit-checklist.md` (ver `brain/16`) |
...
| `10-package.html` · `10-package.txt` | 10 | `tools/package_review.py` (genera; revisión de título/miniatura/descripción con Usuario 002) |
| `10-publish-checklist.md` | 11 | `templates/publish-checklist.md` |
| `11-retro.md` | 12 | `templates/episode-retro.md` |
| `material-search.md` | 0/2 | — (Protocolo 1, `brain/12`) |
