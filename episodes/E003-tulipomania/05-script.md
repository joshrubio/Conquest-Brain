...
> Tono: `brain/08-tone-of-voice.md`. Cierre forma A: `brain/09-reflection-rules.md`.
> Cada afirmación factual lleva un tag `[S..]` que resuelve contra `03-source-log.csv`.
> **v2 — cambio de registro** (nota del revisor): la audiencia no conoce esta historia — se cuenta primero **como leyenda, en toda su grandiosidad** (eso es el gancho), y se desmonta **poco a poco**, no de golpe. Antes esta versión adelantaba la corrección de archivo (Acto 4 original) sin haber presentado siquiera a Mackay (Acto 5 original) — un error de orden, además de un error de registro. v2 reordena: mito completo primero (Actos 1–3) → se revela de dónde sale esa versión (Acto 4, Mackay) → se desarma poco a poco (Actos 5–6, Goldgar + Thompson). Añadidas equivalencias en dólares de hoy donde se citan precios (`S08`).
> **v3 — más contexto, promise/pay más grandiosos** (nota del revisor): se alarga el episodio ampliando el Pivote (Siglo de Oro, la VOC, por qué una flor se vuelve símbolo de estatus — contexto real, no relleno) y añadiendo color de época al auge y al pico (la escena de las tabernas-bolsa, el bulbo corriente que se dispara). Los 4 foreshadowings se reescriben con más teatralidad/humor ("vas a necesitarla", "si eso no te saca una sonrisa"), sin perder el anclaje factual — siguen siendo exactamente las mismas 4 promesas, solo mejor vendidas.
...
| **Registro(s) del cierre** | Psicológico (1 registro — persistencia de mitos simples frente a archivo complejo) |
| Recuento de palabras | ~2.410 (narrado) |
...
Es, probablemente, la primera burbuja financiera de la historia. La pregunta que vamos a responder hoy: ¿pasó, de verdad, como se cuenta?

[HOOK VISUAL] 3 planos, corte seco al ritmo de la voz.
- v1 (~3 s) — pintura de un bodegón de tulipanes del Siglo de Oro neerlandés, colores intensos [S05].
- v2 (~3 s) — un grabado satírico de 1637, gente en una carreta de locos rodeada de flores [S02].
- v3 · «giro» (~4 s) — el Semper Augustus en una lámina de época, la variedad más cara de todas; aguanta ½ s → corte a negro.

[NOTA] Registro: alegoría del mito, sin corregir todavía nada — «se cuenta que» funciona aquí como marcador de género (así empiezan las leyendas), no como corrección. La corrección llega mucho más tarde, en el cuerpo del episodio, nunca en el cold open. HOOK = la pregunta final ("¿pasó de verdad como se cuenta?"); se paga progresivamente en los Actos 4–6.
...
[NOTA] 3–5 s. Sin animación de logo. El pivote entra en el plano siguiente.
...
‹salida señalizada›
Con eso claro, volvamos a los bulbos — porque el más caro de todos, el rey indiscutible de este mercado, está a punto de entrar en escena.

[PROMISE] ‹foreshadowing 1 de 4›
Agárrate a esta idea, porque la vas a necesitar: comprar, con dinero de verdad, una flor que ni siquiera existe todavía. Suena a locura. Dentro de un rato vas a descubrir que era, en realidad, de lo más calculado.
...
En su punto más alto, un solo bulbo de Semper Augustus llegó a valer lo mismo que una de las casas más grandes de los mejores canales de Ámsterdam — cochera, jardín, todo incluido [S01][S08]. Piénsalo un segundo: una flor, del tamaño de un puño, cambiada por una mansión entera. En dinero de hoy, las conversiones varían muchísimo según el método —de varios cientos de miles de dólares hasta cifras bastante más altas—, pero la comparación que sí sostienen los historiadores, sin discutir, es esa: una sola flor por una casa entera [S08].

Y aquí viene lo mejor: nadie —nadie, en toda la República— podía explicar por qué esos pétalos salían partidos en llamas de color en vez de un solo tono liso. Los mejores cultivadores del país lo intentaban todo: distintos suelos, distintos abonos, distintas técnicas de injerto. Y el patrón seguía apareciendo, o desapareciendo, como le daba la gana [S06].

[PROMISE] ‹foreshadowing 2 de 4›
Guarda esa pregunta bajo llave, porque la respuesta va a tardar trescientos años en llegar — y cuando llegue, te vas a reír.

[EXPLICADOR] ‹entrada señalizada›
Hoy sí lo sabemos: ese patrón no era ningún capricho de la planta. Era una enfermedad. Un virus, transmitido por pulgones, que además debilitaba el bulbo con cada generación, hasta que dejaba de florecer del todo [S06]. En el siglo diecisiete no había manera de saberlo — el experimento que lo demostró, con injertos de tejido infectado, no se hizo hasta 1928, en un laboratorio inglés [S06].
‹salida señalizada›
Así que la joya más cara de toda la República era, sin que nadie lo supiera, una planta enferma muriéndose despacio y bonita mientras tanto. Pero en 1636, nadie sabe esto todavía — y los precios solo van a subir.
...
Y aquí la historia se pone, según se cuenta, prácticamente cinematográfica. Dos días después de esa subasta en Haarlem —dos días—, a cientos de kilómetros, en la ciudad de Alkmaar, se celebra la subasta de tulipanes más grande de toda la manía. No la organiza un especulador: la organiza el orfanato de la ciudad, para vender la colección de bulbos que había dejado en herencia un tabernero recién fallecido, padre de siete niños huérfanos [S09]. Noventa y nueve lotes de flores, subastados uno por uno a beneficio de los huérfanos. Un solo bulbo, un Admirael van Enkhuizen, se vende por 5.200 florines. Dos más, de la variedad Virrey, por 4.203 y 3.000 [S09]. Al final del día, la recaudación total ronda los 90.000 florines — una fortuna, repartida entre siete niños que se quedaron sin padre [S09].

Guárdate esta imagen, porque es de las más extrañas de todo el episodio: en el mismo momento en que, según cuenta la leyenda, el mercado entero se estaba derrumbando en pánico, en otro rincón del país los precios de récord seguían pagándose religiosamente — y hay un impreso de la época, con cada lote y cada precio, que lo demuestra [S09].

En los días y semanas siguientes, sí, los precios de muchos contratos se hunden —hasta un 95% en los casos más citados [S01]—, y el pánico se extiende a otras ciudades del mercado. El gremio de floristas de Haarlem propone una salida: los contratos firmados después del 30 de noviembre pueden anularse pagando solo una pequeña parte de lo pactado [S01][S03].
...
|-----|-----------|----------------------|
| S01 | El mercado real, su mecanismo, la cronología del auge/colapso, la ausencia de bancarrotas documentadas | Goldgar, *Tulipmania* (2007) |
| S02 | La versión popular (ruina, la anécdota del marinero), y Mackay como su autor/origen | Mackay, *Extraordinary Popular Delusions* (1841) — citado como objeto, no como hecho |
| S03 | La reinterpretación legal del "colapso" (contratos → opciones anulables) | Thompson, "The tulipmania: Fact or artifact?" (2007) |
...
|---|---------------|-----------|------|
| 1 | Explicador 1 (Pivote) | Acto 5 | El sistema de contratos a futuro no era irracional — era calculable |
| 2 | Acto 1 | Acto 1 (mismo tramo, Explicador) | Nadie sabía por qué "rompían" de color los bulbos, hasta 1928 |
| 3 | Acto 2 | Acto 5 | La palabra "ruina" no significa lo que la leyenda dice que significa |
| 4 (HOOK) | Cold open ("¿pasó de verdad como se cuenta?") | Acto 5 (parcial) + Acto 6 (completo) | Casi nada de lo que se cree sobre la tulipomanía pasó como se cuenta |

## Interludios explicadores — registro

| # | Concepto | Acto | Palabras | Entrada/salida señalizadas |
|---|----------|------|----------|----------------------------|
| 1 | Cómo se compraba/vendía un tulipán (catálogo + contrato a futuro) | Pivote | ~140 | sí |
| 2 | El virus del "romper" de color (1928) | Acto 1 | ~110 | sí |
| 3 | La reinterpretación legal de Thompson (2007) | Acto 6 | ~90 | sí |

## Autorrevisión del guionista (antes de pasar a fact-check)

- [x] Recuento de palabras (~2.410 narradas) para ~15:30 — dentro del objetivo 15–25 min de `brain/02`
- [x] Todo `[S..]` resuelve contra `03-source-log.csv` (S01–S09)
- [x] Orden: cold open → bumper → pivote → narrativa (6 actos) → cierre → CTA
- [x] **Primera vez, no corrección**: el cold open y los Actos 1–3 cuentan la leyenda en toda su grandiosidad, sin hedging correctivo ("se cuenta que" es marcador de género, no una corrección); el desmontaje empieza en el Acto 4 y avanza poco a poco hasta el Acto 6 (`brain/02 §2`)
- [x] Equivalencias en dólares de hoy añadidas donde se citan precios (Semper Augustus, Witte Croonen) — siempre con matiz explícito de incertidumbre en la propia narración, no solo en la nota de producción
- [x] Bumper con fraseo fijo de la casa; CTA cierra con el sign-off fijo
- [x] Cada costura entre secciones lleva un puente
- [x] Cold open ≤ 45 s (36 s); hook + bumper ≤ 50 s (39 s)
- [x] El hook se paga progresivamente (Acto 5 parcial, Acto 6 completo)
...
## Mejoras opcionales (no bloquean el fact-check automático, `brain/14`)

- Extraer del libro completo de Goldgar (no solo reseñas) 2–3 nombres o casos concretos de comerciantes documentados.
- Localizar y verificar el verbatim exacto de la cita de Goldgar sobre por qué persiste el mito antes de usarla textualmente en pantalla.
- Subir de Tier C a A/B el origen del comercio vía el jardín de Clusius, o dejarlo permanentemente marcado como tradición.
- Afinar (o decidir mantener abierto) el rango en dólares de S08 — actualmente deliberadamente amplio por la variación real entre metodologías de conversión.

## Autorrevisión — historial de versiones
