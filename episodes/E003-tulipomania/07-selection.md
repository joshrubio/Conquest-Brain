# Selección — Stage 7 style pass · E003-tulipomania

> Generado por `pull_assets.py --download` desde `07-picks.txt`. Este es el registro de decisiones del pase; se pliega en `07-assets.md`.
...
## Ilustración IA (rótulo «Ilustración — Conquest» en pantalla)

| Beat | id | Res. | Archivo |
|------|----|------|---------|
| 1 | ai01 | 1672x941 | `assets/ai/E003_ai01_hero-amsterdam.png` |
| 2 | ai02 | 1672x941 | `assets/ai/E003_ai02_marinero-bulbo.png` |
| 15 | ai03 | 1672x941 | `assets/ai/E003_ai03_jardin-asalto.png` |
| 25 | ai04 | 1672x941 | `assets/ai/E003_ai04_flor-fantasma.png` |
| 29 | ai05 | 1672x941 | `assets/ai/E003_ai05_cultivadores-experimentos.png` |
| 34 | ai06 | 1672x941 | `assets/ai/E003_ai06_laboratorio-1928.png` |
| 40 | ai07 | 1672x941 | `assets/ai/E003_ai07_taberna-bolsa.png` |
| 49 | ai08 | 1672x941 | `assets/ai/E003_ai08_impreso-resultados.png` |
| 52 | ai09 | 1672x941 | `assets/ai/E003_ai09_gremio-haarlem.png` |
| 53 | ai10 | 1672x941 | `assets/ai/E003_ai10_fortunas-perdidas.png` |
| 59 | ai11 | 1672x941 | `assets/ai/E003_ai11_crisis-britanicas.png` |
| 63 | ai12 | 1672x941 | `assets/ai/E003_ai12_archivo-notarial.png` |
| 69 | ai13 | 1672x941 | `assets/ai/E003_ai13_thompson-articulo.png` |
