...
- [pipeline/1-las-12-etapas](pipeline/1-las-12-etapas.md) — el recorrido completo, quién hace qué, dónde están los "gates". El **script pass** (Stage 4): `tools/script_review.py` → `05-script.html`, un editor de dos columnas — lo que se narra a la izquierda, notas de producción y duración editable por sección a la derecha — con explicador de cada nota técnica al pulsarla. «Finalizar Stage 4» guarda directo en `05-script.md`, sin paso de Claude.
